...
type AuthProviderFunc func(context.Context, *entgen.AuthProviderMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f AuthProviderFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.AuthProviderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.AuthProviderMutation", m)
}

// The AuthUserFunc type is an adapter to allow the use of ordinary
// function as AuthUser mutator.
type AuthUserFunc func(context.Context, *entgen.AuthUserMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f AuthUserFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	if mv, ok := m.(*entgen.AuthUserMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.AuthUserMutation", m)
}
